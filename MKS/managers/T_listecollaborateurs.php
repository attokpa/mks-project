    ...
    <div class="card detail">
        <div class="detail-header">
            <h2>Liste des collaborateurs de MKS</h2>
             <button><a href="inscription.php" class="a"> + Inscription</a></button> 
        ...
        <table>
            ...
            <tr>
                ...
                <td style="display: flex;">
                        ...
                        <a href="supprimer_utilisateurM.php?id=<?=$row["id"]?>"> retirer</a>
                        </span>
                        
                        <!-- <span style="margin-left: 20px;  background-color: #6ebbe4;" class="status onprogress ">
                        <a href="../collaborateurs/platform collaborateurs/Page_presence.php" class="a">Ajouter</a>
                        </span>   -->
                </td>
            </tr>
                <?php } ?>
