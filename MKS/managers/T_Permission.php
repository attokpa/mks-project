...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <span class="fas fa-clipboard-list"></span><p><a href="T_Permission.php">T_Demandes _De <br>Permissions</a></p>
    ...
    <div class="card detail">
        <div class="detail-header">
            <h2>TABLEAUX DES PERMISSIONS</h2>
             <!-- <button><a href="managers/../authentification managers/Ajouter_permission.php" class="a"> + Ajouter</a></button>   -->
