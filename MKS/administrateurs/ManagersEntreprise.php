<?php 
    ...
    $all_manager = $connection->query("SELECT  id, nom, prenom, email, profession, telephone FROM manager");
...
<body>
    ...
    <div class="card detail">
        <div class="detail-header">
            <h2>Liste des Managers de MKS</h2>
            <button><a href="../../mon projet enre/inscription.php" class="a"> + Inscription</a></button> 
        ...
        <table>
            <tr>
                ...
                <?php while($row = $all_manager->fetch()){ ?>
            <tr>
                ...
                <td style="display: flex;">
                        <span class="status confirmed ">
                            <a href="../collaborateurs/platform collaborateurs/supprimer_presence.php?id=<?=$row["id"]?>" > retirer</a>
                        </span>
                        
                         <!-- <span style="margin-left: 20px;  background-color: #6ebbe4;" class="status onprogress ">
                            <a href="../../mon projet enre/inscription.php" > inscrire</a>
                        </span>  -->
                </td>
            </tr>
                <?php } ?>
