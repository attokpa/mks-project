...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <span class="fas fa-fas fa-user"></span><p><a href="T_PresenceAdmin.php">Tableaux D'emargements</a></p>
        </div>
          <div class="sidebar-menu">
       ...
       <div class="sidebar-menu">
            <span class="fas fa-fas fa-user"></span><p><a href="ajouter_professionPourAdministrateur.php">Ajouter une Professsion</a></p>
        </div>  
         <!-- <div class="sidebar-menu">
