<?php 
    ...
    $all_presence = $connection->query("SELECT nom, prenom, profession,date_jour, heure_arrivee, heure_sortie FROM presence INNER JOIN utilisateur ON presence.Id_utilisateur=utilisateur.Id");
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <span class="fas fa-clipboard-list"></span><p><a href="T_PresenceAdmin.php"> T_Presences</a></p>
        ...
        <div class="sidebar-menu">
            <span class="fas fa-clipboard-list"></span><p><a href="T_PermissionAdmin.php">T_Demandes_de <br>Permissions</a></p>
