                ...
                if(filter_var($email, FILTER_VALIDATE_EMAIL)){
                    ...
                    if(!$user){
                        if($mot_de_passe === $confirmer_mot_de_passe){
                            ...
                            $success = "Bravo vous avez ajouter un collaborateur";
                             header("Location: ../administrateurs/utilisateurEntreprise.php");
                        }else{
...
<nav class="navbar">
        <h4>MKS SOFT TECHNOLOGIES 
            ...
            <div class="mun"><li><a href="../administrateurs/utilisateurEntreprise.php" >Accueil</a></li></div>
            
             <div class="mun"><li><a href="../index.php"> Deconnexion</a></li></div> 
             <!-- <div class="mun"><li><a href="../../administrateurs/utilisateurEntreprise.php"> Retirer un collaborateur</a></li></div> 
