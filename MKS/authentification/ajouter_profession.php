...
<nav class="navbar">
        <h4>MKS SOFT TECHNOLOGIES 
            ...
            <div class="mun"><li><a href="../managers/pageM.php" >Accueil</a></li></div>
            
             <div class="mun"><li><a href="../indexes.php"> Deconnexion</a></li></div> 
    ...
    <section>
        ...
        <form method="POST" action="enregistreprofession.php" >
